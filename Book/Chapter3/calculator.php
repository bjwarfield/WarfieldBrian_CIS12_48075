...
<form action="" method="post">
	...
	<p>Ave. Price Per Gallon: <span class="input">
		...
		<input type="radio" name="gallon_price" value="4.50" <?php if(isset($_POST["gallon_price"]) && ($_POST["gallon_price"]=='4.50')){echo 'checked="checked"';} ?>/> 4.50
		<input type="radio" name="gallon_price" value="5.00" <?php if(isset($_POST["gallon_price"]) && ($_POST["gallon_price"]=='5.00')){echo 'checked="checked"';} ?>/> 5.00
	</span></p>
