...
if ($r->num_rows == 1){
	...
	<p> ZIP Code: <input type="text" name="zip_code" id="zip_code" required="required" pattern="^\d{5}(?:-\d{4})?$" size="15" maxlength="10" value="'.$row['zip_code'].'"  /><label for="first_name"></label></p><br/>
	...
	<p> Secondary Phone: <input type="text" name="phone_2" id="phone_2" pattern="^\(\d{3}\)\d{3}-\d{4}$|^$" size="15" maxlength="15" value="('.substr($row['phone_2'],0,3).')'.substr($row['phone_2'],3,3).'-'.substr($row['phone_2'],6,4).'"  /><label for="first_name"></label></p><br/>
