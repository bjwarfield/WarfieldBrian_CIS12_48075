...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (empty($errors)) { // If everything's OK.
		...
		// Make the query:
		$q = "INSERT INTO entity_customers (`first_name`, `last_name`, `email`, `pass`, `registration_date`, `company`, `address_1`, `address_2`, `city`, `state`, `zip_code`, `secutiry_question`, `security_answer`, `phone_1`, `phone_2`, `customer_status_id`) 
...
<p> Sequrity Question: <input type="text" name="security_question" id="security_question" required="required" size="50" maxlength="45" value="<?php if (isset($_POST['security_question'])) echo $_POST['security_question']; ?>"  /><label></label></p><br/>
<p> Sequrity Answer: <input type="text" name="security_answer" id="security_answer" required="required" size="50" maxlength="45" value="<?php if (isset($_POST['security_answer'])) echo $_POST['security_answer']; ?>"  /><label></label></p><br/>
